...
uint32_t read_timer(uint8_t timer_num) {
    switch (timer_num) {
        case 0: return LPC_TIM0->TC;  // Legge Timer 0
        case 1: return LPC_TIM1->TC;  // Legge Timer 1
        case 2: return LPC_TIM2->TC;  // Legge Timer 2
        case 3: return LPC_TIM3->TC;  // Legge Timer 3
        default: return 0;            // Timer non valido, restituisce 0
    }
}
